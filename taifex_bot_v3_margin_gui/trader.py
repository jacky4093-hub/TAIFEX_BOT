...
class SimulatedTrader:
    ...
    def reset(self, initial_equity: float, point_value: int, margin_per_contract: int, contracts: int):
        self.__init__(initial_equity, point_value, margin_per_contract, contracts)
