...
APP_VERSION = load_local_version().get("version", "5.0.12")
...
class TaifexBotGUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(f"TAIFEX Bot V5-0-12 - 下拉選單 dict_keys 修正版")
    ...
    def build_ui(self):
        ...
        title = QLabel(f"台指期多商品多策略模擬交易機器人 V5-0-12  版本：{APP_VERSION}")
