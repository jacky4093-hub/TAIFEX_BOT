...
APP_VERSION = load_local_version().get("version", "5.0.11")
...
class TaifexBotGUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(f"TAIFEX Bot V5-0-11 - 下拉選單改用選單元件修正版")
    ...
    def build_ui(self):
        ...
        title = QLabel(f"台指期多商品多策略模擬交易機器人 V5-0-11  版本：{APP_VERSION}")
